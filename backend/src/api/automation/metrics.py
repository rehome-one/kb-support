...
возможности (напр. assign-стратегия round_robin/least_load до #109) — наблюдаемый
недо-резолв, не сбой.
...
AUTOMATION_ACTION_DEFERRED = Counter(
    ...
    "Действия, не применённые из-за нереализованной возможности (напр. assign-стратегия до #109).",
    ["action", "reason"],
)
