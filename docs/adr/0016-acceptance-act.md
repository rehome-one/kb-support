...
- **Согласовано Архитектором:** да, 2026-06-10 (4 решения — signing-резолв+OTP, мягкая блокировка, авто-каскад, новая операция — ратифицированы; подпись «Принято» проставлена).
